...
\begin{figure}
  ...
  \caption{Fit of step size and dwell time distributions to HC PRP
    data $\chi = 0.22$, $\beta = 0.12$, $k = 2.13$, $\theta = 0.43$,
    $\alpha = 0.14$, $\gamma = 22.56$, $\delta = 2.95$, $\eta =
    2.64$. $V^* = 52$}
...
\begin{figure}
  ...
  \caption{Fit of step size and dwell time distributions to CC PRP
    ...
    $\alpha = 0.13$, $\gamma = 8.62$, $\delta = 2.95$, $\eta =
    1.18$. $V^* = 53$}
...
\begin{figure}
  ...
  \caption{Fit of step size and dwell time distributions to HC whole
    ...
    0.36$, $\alpha = 0.05$, $\gamma = 5.23$, $\delta = 1.88$, $\eta =
    1.57$. $V^* = 68$}
...
\begin{figure}
  ...
  \caption{Fit of step size and dwell time distributions to CC whole
    ...
    0.43$, $\alpha = 0.30$, $\gamma = 6.50$, $\delta = 3.65$, $\eta =
    0.89$. $V^* = 25$}
