...
\graphicspath{{/Users/andrewwork/thesis/jump-velocity/}}
...
\begin{figure}
  ...
  \begin{subfigure}{0.48\textwidth}
    \includegraphics[width=\textwidth]{{avg-vel_a0.2_eps0.1}.png}
    \caption{$\epsilon = 0.1$, $a = 0.2$: Reactions are fast, and
      $k_\tn{on} > k_\tn{off}$.}
  \end{subfigure}
  \hfill
  \begin{subfigure}{0.48\textwidth}
    \includegraphics[width=\textwidth]{{avg-vel_a0.2_eps1}.png}
    \caption{$\epsilon = 1$, $a = 0.2$: Reactions and advection are
      the same order, and $k_\tn{on} > k_\tn{off}$.}
  \end{subfigure}
  \\
  \begin{subfigure}{0.48\textwidth}
    \includegraphics[width=\textwidth]{{avg-vel_a0.5_eps0.1}.png}
    \caption{$\epsilon = 0.1$, $a = 0.5$: Reactions are fast, and
      $k_\tn{on} = k_\tn{off}$.}
  \end{subfigure}
  \hfill
  \begin{subfigure}{0.48\textwidth}
    \includegraphics[width=\textwidth]{{avg-vel_a0.5_eps1}.png}
    \caption{$\epsilon = 0.1$, $a = 0.5$: Reactions and advection are
      the same order, and $k_\tn{on} = k_\tn{off}$.}
  \end{subfigure}
  \\
  \begin{subfigure}{0.48\textwidth}
    \includegraphics[width=\textwidth]{{avg-vel_a0.8_eps0.1}.png}
    \caption{$\epsilon = 0.1$, $a = 0.8$: Reactions are fast, and
      $k_\tn{on} < k_\tn{off}$.}
  \end{subfigure}
  \hfill
  \begin{subfigure}{0.48\textwidth}
    \includegraphics[width=\textwidth]{{avg-vel_a0.8_eps1}.png}
    \caption{$\epsilon = 0.1$, $a = 0.8$: Reactions and advection are
      the same order, and $k_\tn{on} < k_\tn{off}$.}
  \end{subfigure}
...
Observations:
\begin{itemize}
\item Numerical diffusion in the upwind scheme causes some platelets
  to exceed the theoretical maximum crossing velocity: $v_\tn{max} =
  1$.
