...
\usepackage{amsmath}
\usepackage{amsthm}
\usepackage{graphicx, subcaption, algorithmic, booktabs}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=.75\textwidth]{dist-fib-sim}
...
\begin{figure}
  \centering
  \includegraphics[width=0.75\textwidth]{fbg_num_dwells}
...
\begin{figure}
  \centering
  \includegraphics[width=.75\textwidth]{fbg_whl_step}
  \caption{Distributions of observed (solid lines) and simulated
...
\begin{figure}
  \centering
  \includegraphics[width=0.75\textwidth]{fbg_whl_dwl}
  \caption{Distributions of observed (solid lines) and simulated
