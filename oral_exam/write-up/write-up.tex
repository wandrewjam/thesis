...
\thesistype             {what do I put here?}

% \dedication             {For my parents, Alice and Bob.}
\dedication             {Here are some people I like.}

%%% Most students need just a short degree name, like this:
% \degree                 {Doctor of Philosophy}
\degree                 {Doctor of Passing my Oral}
...
\graduatedean           {David Kieda and Katharine Ullman}
\departmentchair        {Davar Khoshnevisan}

%%% The graduate student's committee members:
\committeechair         {Aaron Fogelson}
\firstreader            {Vladimir Hlady}
\secondreader           {James Keener}
\thirdreader            {Christel Hohenegger}
\fourthreader           {Sean Lawley}
...
\submitdate             {March(?) 2019}
\copyrightyear          {2019}

%%% Dates on which committee members approved the thesis
\chairdateapproved      {TBD}
\firstdateapproved      {TBD}
\seconddateapproved     {TBD}
\thirddateapproved      {TBD}
\fourthdateapproved     {TBD}
...
\setcounter {page}     {2}             % UofU Thesis Office demands
                                % abstract on p. iii: start one lower 
